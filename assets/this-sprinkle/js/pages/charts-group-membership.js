/**
 * Target page: /charts-group-membership
...
$(document).ready(function() 
{
    ...
    function setChart( typename, data )
    {
        ...
        myChart = new Chart(ctx, {
            type: typename,
            data: getSimpleChartData(labels_ar, data_ar),
            options: {
                legend: {display:typename == 'pie'},
                'title': {
                    display: true,
                    text: 'Members per Group'
                },
                scales: scales
            }
        });
    ...
    function createChart( typename )
    {
        ...
        if( typename === 'none' )
        {
            ...
            var dataUrl = site.uri.public + '/api/graph/group/memberships';
            $.ajax( dataUrl )
                .done(function( data ) 
                {
    ...
    var default_typename = site.account_graphs.groups.default.typename;
